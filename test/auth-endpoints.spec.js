...
describe('Auth Endpoints', () => {
  ...
  // const { testUsers } = helpers.makeThingsFixtures(); AN EXAMPLE
  ...
  before('cleanup', () => helpers.cleanTables(db)); // make sure this is made

  afterEach('cleanup', () => helpers.cleanTables(db)); // make sure this is made
